<template>
  ...
  <div>
    ...
    <router-link :to="{ name: 'add' }" class="nav-item nav-link" role="button">
      <button class="btn-addroom" type="submit" >
        Add room
    ...
    <table class="table table-bordered-none">
      <thead>
        <tr>
          ...
          <th>
            <div class="param-room"> <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
      ...
      <tbody>
        <tr v-for="room in rooms" :key="room.uid">
          ...
          <td>
            ...
            <router-link :to="{ name: 'edit', params: { uid: room.uid } }"
              style=" color: #707070;border:none;background-color: #ffffff;"><svg xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button class="btn-yes" data-bs-dismiss="modal" @click="deleteRoom(room.uid)">
                      Yes
                    </button>
